...
//Version=1.2
Shader"UNOShader/_Library/UNLIT/UNOShaderUNLIT Transparent Diffuse ShadowAmbient "
{
	Properties
	{
	...
	SubShader
	{
		...
		UsePass "UNOShader/_Library/Helpers/Shadows Transparent/SHADOWCOLLECTOR"
	} //-------------------------------SubShader-------------------------------
